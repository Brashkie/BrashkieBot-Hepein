...
//Alertas
mAdminTrue: '*Tienes privilegios de administrador. No habrá repercusiones* 👻',
...
//antiprivado.js
smsprivado: (m, cuentas) => `*@${m.sender.split`@`[0]} Esta prohibido escribir al privado*\n\n> *Únete a la comunidad BrashkieBot para obtener toda la informacion y conocer cómo puedes tener tú propio Bot para WhatsApp*\n${cuentas}\n\n⚠️ \`\`\`Serás Bloqueado(a)\`\`\` ⚠️`, 
...
//_autodetec.js
smsAutodetec1: (usuario, m) => `*» ${usuario}*\n*ᕼᗩ ᑕᗩᗰᗷIᗩᗪO Eᒪ ᑎOᗰᗷᖇE ᗪEᒪ GᖇᑌᑭO*\n\n🔰 *ᗩᕼOᖇᗩ Eᒪ GᖇᑌᑭO SE ᒪᒪᗩᗰᗩ:*\n*${m.messageStubParameters[0]}*`, 
smsAutodetec2: (usuario, groupMetadata) => `*» ${usuario}*\n*ᗩᕼOᖇᗩ ᕼᗩ ᑕᗩᗰᗷIᗩᗪO ᒪᗩ IᗰᗩGEᑎ ᗪE:*\n*${groupMetadata.subject}*`, 
smsAutodetec3: (usuario, m) => `*» ${usuario}*\n*ᕼᗩ ᑕᗩᗰᗷIᗩᗪO ᒪᗩ ᗪESᑕᖇIᑭᑕIOᑎ ᗪEᒪ GᖇᑌᑭO\n🔰 *𝗡𝗨𝗘𝗩𝗔 𝗗𝗘𝗦𝗖𝗥𝗜𝗣𝗖𝗜𝗢𝗡 𝗘𝗦:*`, 
smsAutodetec4: (usuario, m, groupMetadata) => `🔒 ${usuario}*\n*ᕼᗩ ᑭEᖇᗰITIᗪO ᑫᑌE ${m.messageStubParameters[0] == 'on' ? 'SOᒪO ᗩᗪᗰIᑎS' : '𝙏𝙊𝘿𝙊𝙎'} 𝙋𝙐𝙀𝘿𝘼𝙉 𝘾𝙊𝙉𝙁𝙄𝙂𝙐𝙍𝘼𝙍 ${groupMetadata.subject}*`, 
smsAutodetec5: (groupMetadata, usuario) => `*Eᒪ EᑎᒪᗩᑕE ᗪE ${groupMetadata.subject} ᕼᗩ SIᗪO ᖇESTᗩᗷᒪEᑕIᗪO ᑭOᖇ:*\n*» ${usuario}*`, 
smsAutodetec6: (m) => `Eᒪ GᖇᑌᑭO *${m.messageStubParameters[0] == 'on' ? '𝗘𝗦𝗧𝗔 𝗖𝗘𝗥𝗥𝗔𝗗𝗢 🔒' : '𝗘𝗦𝗧𝗔 𝗔𝗕𝗜𝗘𝗥𝗧𝗢 🔓'}*\n ${m.messageStubParameters[0] == 'on' ? '𝗦𝗢𝗟𝗢𝗦 𝗟𝗢𝗦 𝗔𝗗𝗠𝗜𝗡 𝗣𝗨𝗘𝗗𝗘𝗡 𝗘𝗦𝗖𝗥𝗜𝗕𝗜𝗥' : '𝗬𝗔 𝗣𝗨𝗘𝗗𝗘𝗡 𝗘𝗦𝗖𝗥𝗜𝗕𝗜𝗥 𝗧𝗢𝗗𝗢𝗦'} 𝗘𝗡 𝗘𝗦𝗧𝗘 𝗚𝗥𝗨𝗣𝗢*`, 
smsAutodetec7: (m, usuario) =>  `@${m.messageStubParameters[0].split`@`[0]} ᗩᕼOᖇᗩ ES ᗩᗪᗰIᑎ Eᑎ ESTE GᖇᑌᑭO\n\n🫵ᗩᑕᑕIOᑎ ᖇEᗩᒪIᘔᗩᗪᗩ ᑭOᖇ: ${usuario}`, 
smsAutodetec8: (m,  usuario) => `@${m.messageStubParameters[0].split`@`[0]} ᗪEᒍᗩ ᗪE SEᖇ ᗩᗪᗰIᑎ Eᑎ ESTE GᖇᑌᑭO\n\n🫵ᗩᑕᑕIOᑎ ᖇEᗩᒪIᘔᗩᗪᗩ ᑭOᖇ: ${usuario}`, 
smsAutodetec9: (usuario, m) => `*» ${usuario}*\n*ᕼᗩ ᑕᗩᗰᗷIᗩᗪO ᒪᗩ ᗪᑌᖇᗩᑕIOᑎ ᗪE ᒪOS ᗰEᑎSᗩᒍES TEᗰᑭOᖇᗩᒪES ᗩ : *@${m.messageStubParameters[0]}*`, 
smsAutodetec10: (usuario, m) => `*» ${usuario}*\nᕼᗩ *ᗪEᔕᗩᑕTIᐯO* ᒪOS ᗰEᑎSᗩᒍE TEᗰᑭOᖇᗩᒪ`, 
...
//grupos
smsAdd: 'Hola! me presento, soy BrashkieBot, soy un Bot de WhatsApp, una persona del grupo utilizo el comando para añadirte al grupo, pero no pude agregarte, asi que te mando la invitacion para que te unas al grupo, te esperamos con ansias!!', 
