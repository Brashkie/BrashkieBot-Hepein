...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE BRASHKIEBOT 🌟`}
...
const smsLista7 = () => { return `𒅒 INSTALAR BRASHKIEBOT 𒅒`}
...
const smsBye = () => { return '*░░░░░╔╗╔╗░░░░░░░░░░░░░\n░║║║║░░░░░░░░\n╔╝╚╝╚╗░░░░░░░░░░░░\n║▀▄▀░╠═════╦╗░░░░░\n╚╦═══╝░░░░░╠╝░░░░░*\n*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *Bye!!!, Bye.¡No merecio estar aqui o por algun motivo!!!* 👻\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
...
//_allantilink.js
const smsTextoYT = () => { return '𝗠𝗲𝗴𝗮 BrashkieBot - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
const eGataCoins = () => { return '🐱 BrasCoins' }
const eGataTickers = () => { return '🎫 Bras Tickets' } 
...
const smsTempo1 = () => { return `𒅒 BOT TEMPORAL`}
...
const smsChatAn13 = () => { return `${lenguajeGB['smsAvisoRG']()}𒅒 *ESPERANDO A QUE ALGUIEN SE UNA AL CHAT ANÓNIMO, TENGA PACIENCIA POR FAVOR*`} 
...
const smsMalused2 = () => { return `${lenguajeGB['smsAvisoMG']()}𒅒 *DEBE DE USAR EL COMANDO COMO EN ESTE EJEMPLO:*\n`}
const smsMalused3 = () => { return `${lenguajeGB['smsAvisoMG']()}𒅒 *DEBE DE USAR EL COMANDO O RESPONDER AL MENSAJE DE ALGUIEN COMO EN ESTE EJEMPLO:*\n`}
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 🪄 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 🎈 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, 𝘿𝙄𝙎𝙁𝙍𝙐𝙏𝘼 𝘿𝙀 𝗕𝗥𝗔𝗦𝗛𝗞𝗜𝗘𝗕𝗢𝗧!!! 𖣐\n\n💖 𝗕𝗥𝗔𝗦𝗛𝗞𝗜𝗘𝗕𝗢𝗧 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝘼 𝙋𝙊𝙍:\n@${user}`}
...
const smsContacto4 = () => { return 'Contacto Oficial de BrashkieBot 𖣐'}
