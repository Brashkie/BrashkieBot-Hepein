...
let text
   ...
   if (!text) return m.reply('𝘿𝙤𝙣𝙙𝙚 𝙘𝙖𝙧𝙖𝙟𝙤𝙨 𝙚𝙨t𝙖 𝙚𝙡 𝙩𝙚𝙭𝙩𝙤?')
   if (text.length > 30) return m.reply('𝙈𝘼𝙓𝙄𝙈𝙊 30 𝙋𝘼𝙇𝘼𝘽𝙍𝘼𝙎!')
    let pp = await conn.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/e667219ff9d1c9953ef8f.jpg')
