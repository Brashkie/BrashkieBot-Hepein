...
this.sendMessage(m.chat, {text: `🪙 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝘾𝙊𝙄𝙉𝙎`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𒅒 𝗠𝗲𝗴𝗮 𝗕𝗿𝗮𝘀𝗵𝗸𝗶𝗲𝗕𝗼𝘁 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
...
"thumbnail": apii.data, 
"title": [wm, '𒅒 𝗦𝘂𝗽𝗲𝗿 ' + gt + ' 𒅒', '𒅒 electronicatodo2006@gmail.com'].getRandom(),
