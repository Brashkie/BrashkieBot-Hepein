...
if wget -q https://github.com/Brashkie/BrashkieBot-Hepein/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/Brashkie/BrashkieBot-Hepein.git
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} BrashkieBot${b}: "
	read opcion
	case $opcion in
            01|1)
                am start -a android.intent.action.VIEW https://chat.whatsapp.com/CnBH1Cdi1pG9jWjmAeUVGW &>> /dev/null
...
echo -e "\033[01;32m\033[01mIniciando BrashkieBot!!\nStarting BrashkieBot!!\n\033[0m"
npm run qr
